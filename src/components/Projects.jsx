...
import floralHavenImage from '../images/WhatsApp Image 2024-07-08 at 13.55.24_9e9e16cb.jpg'; // Adjust the path as needed
...
const Projects = () => {
  return (
    <section id="projects">
      ...
      <img src={floralHavenImage} alt="FloralHaven Project" className="project-image" />
